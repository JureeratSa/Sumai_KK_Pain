        ...
        <header className="header">
            ...
            <div className="header-right">
                <button className="icon-btn">
                    <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M23 4v6h-6"></path><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>
                </button>
                ...
                <div className="user-profile">
                    ...
                    <div className="user-info">
                        <span className="user-name">ICU</span>
                        <span className="user-role">แผนก</span>
                    </div>
                </div>
            </div>
        </header>
